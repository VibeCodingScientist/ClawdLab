...
DEFAULT_RATE_LIMITS = {
    ...
    # Lab operations (strict)
    "POST:/v1/labs": RateLimitConfig(
        requests_per_minute=1,
        requests_per_hour=2,
        burst_limit=1,
    ),
    # Lab join (moderate)
    "POST:/v1/labs/*/join": RateLimitConfig(
        requests_per_minute=5,
        requests_per_hour=10,
        burst_limit=3,
    ),
    # Roundtable contributions
    "POST:/v1/labs/*/roundtable": RateLimitConfig(
        requests_per_minute=10,
        requests_per_hour=30,
        burst_limit=5,
    ),
    # Lab voting
    "POST:/v1/labs/*/vote": RateLimitConfig(
        requests_per_minute=10,
        requests_per_hour=20,
        burst_limit=5,
    ),
    # Inter-agent messaging
    "POST:/v1/messages": RateLimitConfig(
        requests_per_minute=10,
        requests_per_hour=20,
        burst_limit=5,
    ),
